...
(function (r, i) {
    ...
    function on_height_change(t) {
        var n = window.visualViewport.height;
        t(n);
    ...
    $.fn.terminal = function (e, t) {
            ...
            try {
                ...
                if (r !== "") {
                    if (!n.raw) {
                        ...
                        if (n.formatters) {
                            try {
                                r = $.terminal.apply_formatters(r, $.extend(F, {
                                    echo: true
                                }))
                            } catch (e) {
                                D(e, "FORMATTING")
        ...
        function i(e) {
            ...
            try {
                b.clear();
                unpromise(w.render(C.rows(), function (e) {
                    return e.map(re)
                }), function () {
                    C.flush(e);
                    if (!e.update) {
        ...
        function ke(y, b) {
            return function e(o, s) {
                var l = $.terminal.apply_formatters(o, {
                    animation: true
                });
        ...
        function Oe(u, i, a, o) {
            ...
            C.push(function (i) {
                C.set_mask(F.maskChar).push(function (r) {
                    try {
                        je(i, r, function (e) {
                            if (e === false) {
                                s();
        ...
        var Me = $.omap({
            ...
            signature: function () {
                return `Windows Terminal\nCopyright (c) 2011-2023 jcubic. All rights reserved.\n`
                var e = C.cols();
            ...
            flush: function (d) {
                ...
                p(function e() {
                    try {
                        ...
                        var D = C.offset();
                        C.stopTime("flush").oneTime(10, "flush", function () {
                            var e = _.height();
                            var t = B.height();
                            css(C[0], {
                                ...
                                "--terminal-scroll": S.prop("scrollTop"),
                                "--cmd-top": e,
                                "--cmd-height": t
                            });
                            if (E && !is_mobile) {
                ...
                p(function e() {
                    if (l()) {
                        if (t === "prompt") {
                            ...
                            with_prompt(C.get_prompt(), function (e) {
                                Se(e, n, u)
                            }, C)
                        } else if (t === "insert") {
                            with_prompt(C.get_prompt(), function (e) {
            ...
            destroy: function () {
                p(function e() {
                    ...
                    $(window).off("blur", vt).off("focus", dt);
        ...
        var nt, rt, it;
        var ut = [];
        var F = $.extend({}, $.terminal.defaults, {
            name: C.selector,
            // exit: !!(t && t.login || !t)
        }, t || {});
        ...
        if (typeof e === "string") {
            ...
            for (var z = 0, Dt = e.length; z < Dt; ++z) {
        ...
        if (is_function(F.login)) {
            I = F.login
        } else if (mt && (typeof F.login === "string" || F.login === true)) {
            I = Z(mt, F.login)
        }
        terminals.append(C);
        ...
        function ht() {
            var e = ct[0].getBoundingClientRect();
            return e.width || 1
        }
        ...
        $(document).on("paste.terminal_" + C.id(), yt);
        var P = $.extend({}, Ee, $.omap(F.keymap || {}, function (n, r) {
            if (!Ee[n]) {
                return r.bind(C)
            }
            return function (e, t) {
        ...
        X(e, F.login, function (e) {
            ...
            C.oneTime(100, function () {
                $(document).bind("click.terminal_" + C.id(), n).bind("contextmenu.terminal_" + C.id(), n)
            });
            var r = $(window);
            ...
            if (is_mobile) {
                ...
                if ("visualViewport" in window) {
                    on_height_change(function (e) {
                        css(document.documentElement, {
                            "--terminal-force-height": e + "px"
                        })
                    })
                }
            } else {
                r.on("focus.terminal_" + C.id(), dt).on("blur.terminal_" + C.id(), vt);
                var h;
                (function () {
                    var t = 0;
                    var n;
            ...
            function a() {
                ...
                ct.resizer("unbind").resizer(function () {
                    O = ht();
                    C.refresh()
                }, e);
            ...
            if (F.execHash) {
                ...
                var i = false;
                $(document).bind("keydown.terminal_" + C.id(), function (e) {
                    if (e.shiftKey) {
                        i = true
                    }
